...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // if (points === GAME_WORDS.length-1) {
    //     console.log("Felicidades, concluiste el game!");
    //     setIsGameOver(true);
    //     return;
    // }

    // setPoints(points+1);
    // let data = words.filter((e) => e !== currentWord);
    // setCurrentWord(data[points]);
    // setScrambledWord(scrambleWord(data[points]));
  };

  const handleSkip = () => {
    console.log('Palabra saltada: ', skipCounter);
    //* mine
  ...
  return (
    <div className="min-h-screen bg-gradient-to-brXD bg-gray-800 from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto">
        {/* Header */}
        ...
        {/* Main Game Card */}
        <Card className="backdrop-blur-sm bg-primary bgXD-white/80 border-0 shadow-xl">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="text-center text-lg font-semibold h-12 border-2 border-indigo-200 focus:border-indigo-500 transition-colors text-white XD"
